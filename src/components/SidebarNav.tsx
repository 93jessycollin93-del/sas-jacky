...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "✅ Agent Evals", href: "/agent-evals", title: "Score an agent against a fixed suite of cases with deterministic checks — repeatable, so you can tell if a prompt change actually helped" },
